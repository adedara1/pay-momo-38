...
const settingsRoutes = ['/configuration', '/editeur', '/donnees', '/page-apercu', '/try-productform', '/try', '/menu-settings'];
    ...
    <div className="flex min-h-screen max-w-[100vw] overflow-x-hidden">
      ...
      <main className={`flex-1 w-full overflow-y-auto ${shouldShowSidebar ? 'md:ml-64 max-w-7xl mx-auto' : 'md:w-full'}`}>
        <Routes>
          ...
          <Route path="/menu-settings" element={<ProtectedRoute checkAdmin={true}><MenuSettings /></ProtectedRoute>} />
