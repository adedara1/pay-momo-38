  ...
  public: {
    Tables: {
      ...
      trial_products: {
        ...
        Relationships: [
          {
            foreignKeyName: "trial_products_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      trial_transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "trial_transactions_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "trial_products"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "trial_transactions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
